...
def draw_vicuna_A100_total_combined(multihops_qualities, multihops_thresholds, specifics_qualities, specifics_thresholds, metric, time_type, save_name, save_dir, is_subplot=False, **kwargs):
    ...
    ax = brokenaxes(xlims=((70, 630), (10640,10700)), despine=False, subplot_spec=spec, **bax_opts)
    ...
    ax.set_title('Vicuna', fontsize=16)
...
def draw_vicuna_A100_inference_combined(multihops_qualities, multihops_thresholds, specifics_qualities, specifics_thresholds, metric, time_type, save_name, save_dir, is_subplot=False, **kwargs):
    from constants.plot_A100 import anno_opts, bax_opts
    ...
    ax = brokenaxes(xlims=((50, 600), (9980,10020)), despine=False, subplot_spec=spec, **bax_opts)
