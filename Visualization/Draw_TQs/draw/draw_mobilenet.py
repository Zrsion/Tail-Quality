...
def draw_mobilenet_A100_total_combined(multihops_qualities, multihops_thresholds, specifics_qualities, specifics_thresholds, metric, time_type, save_name, save_dir, is_subplot=False, **kwargs):
    ...
    ax = brokenaxes(xlims=((0, 1900), (9600, 9800)), despine=False, subplot_spec=spec, **bax_opts)
    ...
    ax.set_title('MobileNet', fontsize=16)
...
def draw_mobilenet_A100_inference_combined(multihops_qualities, multihops_thresholds, specifics_qualities, specifics_thresholds, metric, time_type, save_name, save_dir, is_subplot=False, **kwargs):
    from constants.plot_A100 import anno_opts, bax_opts
    ...
    ax = brokenaxes(xlims=((4.5, 23), (1551.5, 1553)), despine=False, subplot_spec=spec, **bax_opts)
