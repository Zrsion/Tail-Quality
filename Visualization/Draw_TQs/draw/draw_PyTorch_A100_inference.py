...
if __name__ == '__main__':
    ...
    ax1 = draw_detr_A100_inference_combined(detr_multihops_qualities, detr_multihops_thresholds, detr_specifics_qualities, detr_specifics_thresholds, detr_metric, time_type, save_name, save_dir, is_subplot=True, spec=specs[0,0])
    ax2 = draw_vicuna_A100_inference_combined(vicuna_multihops_qualities, vicuna_multihops_thresholds, vicuna_specifics_qualities, vicuna_specifics_thresholds, vicuna_metric, time_type, save_name, save_dir, is_subplot=True, spec=specs[0,1])
    ax3 = draw_lightgcn_A100_inference_combined(lightgcn_multihops_qualities, lightgcn_multihops_thresholds, lightgcn_specifics_qualities, lightgcn_specifics_thresholds, lightgcn_metric, time_type, save_name, save_dir, is_subplot=True, spec=specs[0,2])
    ax4 = draw_hybridnets_A100_inference_combined(hybridnets_multihops_qualities, hybridnets_multihops_thresholds, hybridnets_specifics_qualities, hybridnets_specifics_thresholds, hybridnets_metric, time_type, save_name, save_dir, is_subplot=True, spec=specs[1,0])
    ax5 = draw_mobilenet_A100_inference_combined(mobilenet_multihops_qualities, mobilenet_multihops_thresholds, mobilenet_specifics_qualities, mobilenet_specifics_thresholds, mobilenet_metric, time_type, save_name, save_dir, is_subplot=True, spec=specs[1,1])
    ax6 = draw_emotionflow_A100_inference_combined(emotionflow_multihops_qualities, emotionflow_multihops_thresholds, emotionflow_specifics_qualities, emotionflow_specifics_thresholds, emotionflow_metric, time_type, save_name, save_dir, is_subplot=True, spec=specs[1,2])
