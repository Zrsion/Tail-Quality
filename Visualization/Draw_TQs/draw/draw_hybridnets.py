...
def draw_hybridnets_A100_total_combined(multihops_qualities, multihops_thresholds, specifics_qualities, specifics_thresholds, metric, time_type, save_name, save_dir, is_subplot=False, **kwargs):
    ...
    ax = brokenaxes(xlims=((80, 160), (19865, 19875)), despine=False, subplot_spec=spec, **bax_opts)
    ...
    ax.set_title('HybridNets', fontsize=16)
...
def draw_hybridnets_A100_inference_combined(multihops_qualities, multihops_thresholds, specifics_qualities, specifics_thresholds, metric, time_type, save_name, save_dir, is_subplot=False, **kwargs):
    from constants.plot_A100 import anno_opts, bax_opts
    ...
    ax = brokenaxes(xlims=((70, 160), (11930, 11940)), despine=False, subplot_spec=spec, **bax_opts)
