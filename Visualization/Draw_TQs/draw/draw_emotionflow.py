...
def draw_emotionflow_A100_total_combined(multihops_qualities, multihops_thresholds, specifics_qualities, specifics_thresholds, metric, time_type, save_name, save_dir, is_subplot=False, **kwargs):
    ...
    ax = brokenaxes(xlims=((110, 125), (196, 198)), despine=False, subplot_spec=spec, **bax_opts)
    ...
    ax.set_title('EmotionFlow', fontsize=16)
...
def draw_emotionflow_A100_inference_combined(multihops_qualities, multihops_thresholds, specifics_qualities, specifics_thresholds, metric, time_type, save_name, save_dir, is_subplot=False, **kwargs):
    from constants.plot_A100 import anno_opts, bax_opts
    ...
    print(multihops_thresholds[-1])
    ax = brokenaxes(xlims=((110, 125), (193, 195)), despine=False, subplot_spec=spec, **bax_opts)
