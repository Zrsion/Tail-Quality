...
def draw_lightgcn_A100_total_combined(multihops_qualities, multihops_thresholds, specifics_qualities, specifics_thresholds, metric, time_type, save_name, save_dir, is_subplot=False, **kwargs):
    ...
    ax = brokenaxes(xlims=((15, 45), (460, 466)), despine=False, subplot_spec=spec, **bax_opts)
    ...
    ax.set_title('LightGCN', fontsize=16)
    ...
    ax.set_ylabel(f'Inference Quality ({metric})',fontsize=14, labelpad=35)
...
def draw_lightgcn_A100_inference_combined(multihops_qualities, multihops_thresholds, specifics_qualities, specifics_thresholds, metric, time_type, save_name, save_dir, is_subplot=False, **kwargs):
    from constants.plot_A100 import anno_opts, bax_opts
    ...
    ax = brokenaxes(xlims=((0.5, 1), (141.9, 142)), despine=False, subplot_spec=spec, **bax_opts)
    ...
    text = 'Tail Quality:\n'
    print(spe_maxs)
    print('multihops_thresholds[0]:', multihops_thresholds[0])
    print('multihops_thresholds[-1]:', multihops_thresholds[-1])
